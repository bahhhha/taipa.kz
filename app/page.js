	...
	return (
		<main className="pt-10">
			...
			<div className="text-white text-center m-auto md:w-[720px] font-light pt-8 pb-12 text-lg">
				Explore the rich tapestry of your lineage, uncover
				hidden tales of triumph and resilience, and embark
				on a captivating journey of discovery as you connect
				with the roots of your family tree. Celebrate the
				legacy of those who came before, and let their
				stories inspire and guide you on your own path.
			</div>
